...
public class TextFilesExercise2 {
	 ...
	 * y finalmente guarda en un nuevo archivo, cada línea con el nuevo formato. 
	 */
		...
		try {
			...
			try {
				...
				while(f.hasNextLine()) {
					...
					/*	En la siguiente línea utilizamos el especificador 'width' de String format() para indicar la cantidad de caracteres deseados,
