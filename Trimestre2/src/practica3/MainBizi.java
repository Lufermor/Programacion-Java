...
public class MainBizi {
	 ...
	 * comprueba que el dato introducido sea un número entero.
	 */
	...
	/*
	 * Pre: ---
	 * Post: Este metodo comprueba si el usuario pasado como parámetro está en el arrayList
	...
	/*
	 * Pre: ---
	 * Post: Este método muestra por pantalla los 15 primeros elementos de un arrayList de usuarios,
	 ...
	 * luego muestra por pantalla los usos totales, los circulares y los traslados
	 * de los 15 usuarios más activos.
	 */
	public static void usosPorUsuario(Scanner entrada, ArrayList<UsuarioBizi> usuarios) {
		...
		/*Con la siguiente línea ordenamos la lista de usuarios por el valor de 
